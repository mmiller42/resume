(function (window, document, $, undefined) {
	...
	// Some reusable jQuery instances of common elements
	var $window = $(window);
	var $document = $(document);

	(function manageGrayBg () {
	...
	(function manageAffixedElements () {
	...
	(function manageSkillsListColumns () {
